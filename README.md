...
[세 사례를 브라우저에서 비교](examples/index.html) · [발췌와 전체 파일](examples/README.md)

### 산업별 기업 AX 사례

자동 검사 **실패** · 의미 검토 **확인 필요**. [전체 비교](examples/posts/2026-08-19-ai-agent-industry-ax-cases/comparison.html)
...
변경 이유: 설명 예고를 줄이고 질문의 대상을 업무가 달라진 기업으로 명시했습니다. 미결은 전체 비교에서 확인할 수 있습니다.

### Claude Cowork 마케팅 시스템

자동 검사 **통과** · 의미 검토 **독립 검토 완료**. [전체 비교](examples/posts/2026-06-29-claude-cowork-marketing-system/comparison.html)
...
변경 이유: 사다리 비유를 작업 순서로 풀고 단계 숫자는 보존했습니다. 미결은 전체 비교에서 확인할 수 있습니다.

### 메타프롬프팅으로 나만의 스킬 만들기

자동 검사 **실패** · 의미 검토 **확인 필요**. [전체 비교](examples/posts/2026-06-26-메타프롬프팅-나만의-스킬/comparison.html)
...
변경 이유: '렌즈'라는 은유를 '관점'으로 바꿔 표현을 직접적으로 다듬었습니다. 미결은 전체 비교에서 확인할 수 있습니다.

## 코드와 LLM의 작업 절차

[전체 흐름](examples/workflow/01-overview.svg) · [검수·수정 흐름](examples/workflow/02-review-loop.svg) · [실행 기록과 단계별 피드백](examples/workflow/README.md)
